    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid gap-2">
          ...
          >
            <h2 className="text-sm font-medium text-slate-100">
              (Cell-to-cell interaction: Step 1) Spatial Distance Permutation Test
            </h2>
            <p className="text-xs text-slate-400 mt-0.5">
          ...
          >
            <h2 className="text-sm font-medium text-slate-100">
              (Cell-to-cell interaction: Step 2) Spatial Distance Analysis
            </h2>
            <p className="text-xs text-slate-400 mt-0.5">
          ...
          >
            <h2 className="text-sm font-medium text-slate-100">
              (Cell-to-cell interaction: Step 3) Cell-Cell Interaction Analysis
            </h2>
            <p className="text-xs text-slate-400 mt-0.5">
          ...
          >
            <h2 className="text-sm font-medium text-slate-100">
              (Cell-to-cell interaction: Step 4) Attraction-Avoidance Heatmap
            </h2>
            <p className="text-xs text-slate-400 mt-0.5">
